...
**Validate:** You know your local IP (192.168.1.x), your gateway, your DNS server, and whether you can reach the internet.
...
# Can I resolve names?
nslookup portal2 2>/dev/null || echo "No DNS for portal2"
getent hosts portal2 2>/dev/null || echo "Not in hosts"
cat /etc/hosts
```
...
curl -s http://192.168.1.64:9090/api/messages?limit=5 2>/dev/null | python3 -m json.tool 2>/dev/null

# Check for other Pis
ssh -o ConnectTimeout=3 -o BatchMode=yes portal2 "hostname" 2>/dev/null
```

**Validate:** You know whether AgentChat exists and whether portal2 is reachable.
...
for ip in $(sudo nmap -sn 192.168.1.0/24 -oG - | grep "Up" | awk '{print $2}'); do
    echo "=== $ip ==="
...
ls /home/clawd/ 2>/dev/null && echo "Found clawd workspace"
ls /home/clawd/SOUL.md 2>/dev/null && head -50 /home/clawd/SOUL.md
ls /home/clawd/LEARN.md 2>/dev/null && wc -l /home/clawd/LEARN.md
ls /home/clawd/memory/ 2>/dev/null && ls /home/clawd/memory/ | tail -5

# Check for build artifacts
ls /home/clawd/systems/ 2>/dev/null
ls /home/clawd/skills/ 2>/dev/null && ls /home/clawd/skills/
```
...
facts = [
    ...
    ("network", "My IP is on the 192.168.1.x subnet", "step 3", 1.0),
...
start = time.time()
hosts = [f"192.168.1.{i}" for i in range(1, 20)]
for ip in hosts:
    check_host(ip)
...
```bash
cat /home/clawd/SOUL.md 2>/dev/null || cat ~/SOUL.md 2>/dev/null || echo "No SOUL.md found"
```
...
cat /home/clawd/systems/orchestrator/PRINCIPLES.md 2>/dev/null | head -60
cat /home/clawd/LEARN.md 2>/dev/null | head -100

# Study the eval system
ls /home/clawd/evals/ 2>/dev/null
cat /home/clawd/evals/prompts/*.txt 2>/dev/null | head -100

# Study the agent infrastructure
cat /home/clawd/systems/ARMADA.md 2>/dev/null | head -100
```
