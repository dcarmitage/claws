...
BUILD_LOG = "$CLAWS_HOME/systems/orchestrator/build_log.py"
TASKBOARD_PY = "$CLAWS_HOME/systems/orchestrator/taskboard.py"
...
def cmd_post(args):
    ...
    assignee = args.assignee or "agent-beta"
...
def main():
    ...
    p.add_argument("--assignee", default="agent-beta", help="Agent to assign (default: agent-beta)")
    ...
    p.add_argument("agent_id", help="Agent ID (e.g. agent-beta)")
